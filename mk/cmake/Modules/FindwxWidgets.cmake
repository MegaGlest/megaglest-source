...
ELSE(wxWidgets_FIND_STYLE STREQUAL "win32")
  IF(wxWidgets_FIND_STYLE STREQUAL "unix")
    ...
    MESSAGE(STATUS "DEBUG FreeBSD: ${wxWidgets_CONFIG_EXECUTABLE}")
    ...
    IF(wxWidgets_CONFIG_EXECUTABLE)
      ...
      MESSAGE(STATUS "run the wx-config program to get cxxflags:") 
      EXECUTE_PROCESS(
        COMMAND sh "${wxWidgets_CONFIG_EXECUTABLE}"
      ...
      ELSE(RET EQUAL 0)
        SET(wxWidgets_FOUND FALSE)
        MESSAGE(STATUS "run the wx-config program to get cxxflags FAILED")
        DBG_MSG_V(
