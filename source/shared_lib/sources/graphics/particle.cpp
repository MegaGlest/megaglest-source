...
void ParticleSystem::setFactionColor(Vec3f factionColor) {
    ...
    for (int i = getChildCount() - 1; i >= 0; i--) getChild(i)->setFactionColor(factionColor);
}
...
GameParticleSystem::GameParticleSystem(int particleCount)
    : ParticleSystem(particleCount), primitive(pQuad), model(NULL), modelCycle(0.0f), offset(0.0f), direction(0.0f, 1.0f, 0.0f), tween(0.0f) {}
...
UnitParticleSystem::UnitParticleSystem(int particleCount) : GameParticleSystem(particleCount), parent(NULL) {
...
void UnitParticleSystem::initParticle(Particle *p, int particleIndex) {
    ...
    case sLinear: {
        ...
        p->speed = Vec3f(direction.x + direction.x * random.randRange(-0.5f, 0.5f), direction.y + direction.y * random.randRange(-0.5f, 0.5f),
...
AttackParticleSystem::AttackParticleSystem(int particleCount) : GameParticleSystem(particleCount) {
    primitive = pQuad;
    gravity = 0.0f;
    sizeNoEnergy = 0.0;
}
...
void SplashParticleSystem::initParticle(Particle *p, int particleIndex) {
    ...
    p->speed = Vec3f(horizontalSpreadA * random.randRange(-1.0f, 1.0f) + horizontalSpreadB, verticalSpreadA * random.randRange(-1.0f, 1.0f) + verticalSpreadB,
