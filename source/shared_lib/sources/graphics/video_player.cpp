...
std::string getRegKey(const std::string &location, const std::string &name) {
  ...
  long ret;
  ret = RegOpenKeyExA(HKEY_LOCAL_MACHINE, location.c_str(), 0, KEY_QUERY_VALUE,
                      &key);
...
static inline void loadTexture(class ctx *ctx) {
  ...
  for (int i = ctx->height; i > 0; i--) {
    for (int j = 0; j < ctx->width; j++) {
      pixelSource =
          (Uint8 *)ctx->surf->pixels + (i - 1) * ctx->surf->pitch + j * 2;
      pix = *(Uint16 *)pixelSource;
      SDL_GetRGBA(pix, ctx->surf->format, &(pixelDestination[0]),
                  &(pixelDestination[1]), &(pixelDestination[2]),
                  &(pixelDestination[3]));
      pixelDestination += 4;
    }
  }
  ...
  glTexImage2D(GL_TEXTURE_2D, 0, 4, ctx->width, ctx->height, 0, GL_RGBA,
               GL_UNSIGNED_BYTE, (Uint8 *)rawData);
}
...
static void display(void *data, void *id) {
  ...
  if (ctx->verboseEnabled)
    ...
    defined(LIBVLC_VERSION_PRE_1_1_0)
...
void callbacks(const libvlc_event_t *event, void *data) {
  ...
  case libvlc_MediaPlayerEndReached:
    if (ctx->verboseEnabled)
      printf("libvlc_MediaPlayerEndReached\n");
  ...
  case libvlc_MediaPlayerPositionChanged:
    // qDebug() << self << "position changed : " <<
    // event->u.media_player_position_changed.new_position; self->emit
    // positionChanged( event->u.media_player_position_changed.new_position );
    if (ctx->verboseEnabled)
  ...
  case libvlc_MediaPlayerSnapshotTaken:
    if (ctx->verboseEnabled)
      printf("libvlc_MediaPlayerSnapshotTaken\n");
    break;
  ...
  case libvlc_MediaPlayerSeekableChanged:
    if (ctx->verboseEnabled)
      printf("libvlc_MediaPlayerSeekableChanged\n");
    break;
  case libvlc_MediaPlayerPausableChanged:
    if (ctx->verboseEnabled)
      printf("libvlc_MediaPlayerPausableChanged\n");
    break;
  case libvlc_MediaPlayerTitleChanged:
    if (ctx->verboseEnabled)
      printf("libvlc_MediaPlayerTitleChanged\n");
    break;
  case libvlc_MediaPlayerNothingSpecial:
    if (ctx->verboseEnabled)
      printf("libvlc_MediaPlayerNothingSpecial\n");
    break;
  ...
  case libvlc_MediaPlayerForward:
    if (ctx->verboseEnabled)
      printf("libvlc_MediaPlayerForward\n");
    break;
  case libvlc_MediaPlayerBackward:
    if (ctx->verboseEnabled)
      printf("libvlc_MediaPlayerBackward\n");
    break;
  case libvlc_MediaStateChanged:
    if (ctx->verboseEnabled)
      printf("libvlc_MediaStateChanged\n");
    break;
  case libvlc_MediaParsedChanged:
    if (ctx->verboseEnabled)
      printf("libvlc_MediaParsedChanged\n");
    break;

#if defined(LIBVLC_VERSION_PRE_2) && defined(LIBVLC_VERSION_PRE_1_1_0)
  case libvlc_MediaPlayerVout:
    if (ctx->verboseEnabled)
      printf("libvlc_MediaPlayerVout\n");
    break;
#endif
  case libvlc_MediaListItemAdded:
    if (ctx->verboseEnabled)
      printf("libvlc_MediaListItemAdded\n");
    break;
  case libvlc_MediaListWillAddItem:
    if (ctx->verboseEnabled)
      printf("libvlc_MediaListWillAddItem\n");
    break;
  case libvlc_MediaListItemDeleted:
    if (ctx->verboseEnabled)
      printf("libvlc_MediaListItemDeleted\n");
    break;
  case libvlc_MediaListWillDeleteItem:
    if (ctx->verboseEnabled)
      printf("libvlc_MediaListWillDeleteItem\n");
    break;
  case libvlc_MediaListViewItemAdded:
    if (ctx->verboseEnabled)
      printf("libvlc_MediaListViewItemAdded\n");
    break;
  case libvlc_MediaListViewWillAddItem:
    if (ctx->verboseEnabled)
      printf("libvlc_MediaListViewWillAddItem\n");
    break;
  case libvlc_MediaListViewItemDeleted:
    if (ctx->verboseEnabled)
      printf("libvlc_MediaListViewItemDeleted\n");
    break;
  case libvlc_MediaListViewWillDeleteItem:
    if (ctx->verboseEnabled)
      printf("libvlc_MediaListViewWillDeleteItem\n");
    break;
  case libvlc_MediaListPlayerPlayed:
    if (ctx->verboseEnabled)
      printf("libvlc_MediaListPlayerPlayed\n");
    break;
  case libvlc_MediaListPlayerNextItemSet:
    if (ctx->verboseEnabled)
      printf("libvlc_MediaListPlayerNextItemSet\n");
    // ctx->isPlaying = true;
    // ctx->started = true;
    ctx->end_of_media = false;
    ctx->error = false;
  ...
  case libvlc_MediaListPlayerStopped:
    if (ctx->verboseEnabled)
      printf("libvlc_MediaListPlayerStopped\n");
    ctx->stopped = true;
  ...
  case libvlc_MediaDiscovererStarted:
    if (ctx->verboseEnabled)
      printf("libvlc_MediaDiscovererStarted\n");
    break;
  case libvlc_MediaDiscovererEnded:
    if (ctx->verboseEnabled)
      printf("libvlc_MediaDiscovererEndedvvvvvvvvv\n");
    break;
  case libvlc_VlmMediaAdded:
    if (ctx->verboseEnabled)
      printf("libvlc_VlmMediaAdded\n");
    break;
  case libvlc_VlmMediaRemoved:
    if (ctx->verboseEnabled)
      printf("libvlc_VlmMediaRemoved\n");
    break;
  case libvlc_VlmMediaChanged:
    if (ctx->verboseEnabled)
      printf("libvlc_VlmMediaChanged\n");
    break;
  case libvlc_VlmMediaInstanceStarted:
    if (ctx->verboseEnabled)
      printf("libvlc_VlmMediaInstanceStarted\n");
    break;
  case libvlc_VlmMediaInstanceStopped:
    if (ctx->verboseEnabled)
      printf("libvlc_VlmMediaInstanceStopped\n");
    ctx->stopped = true;

    break;
  case libvlc_VlmMediaInstanceStatusInit:
    if (ctx->verboseEnabled)
      printf("libvlc_VlmMediaInstanceStatusInit\n");
    break;
  case libvlc_VlmMediaInstanceStatusOpening:
    if (ctx->verboseEnabled)
      printf("libvlc_VlmMediaInstanceStatusOpening\n");
    break;
  case libvlc_VlmMediaInstanceStatusPlaying:
    if (ctx->verboseEnabled)
      printf("libvlc_VlmMediaInstanceStatusPlaying\n");
    break;
  case libvlc_VlmMediaInstanceStatusPause:
    if (ctx->verboseEnabled)
      printf("libvlc_VlmMediaInstanceStatusPause\n");
    break;
  case libvlc_VlmMediaInstanceStatusEnd:
    if (ctx->verboseEnabled)
      printf("libvlc_VlmMediaInstanceStatusEnd\n");
    break;
  case libvlc_VlmMediaInstanceStatusError:
    if (ctx->verboseEnabled)
      printf("libvlc_VlmMediaInstanceStatusError\n");
    break;
...
VideoPlayer::VideoPlayer(VideoLoadingCallbackInterface *loadingCB,
                         string filename, string filenameFallback,
                         SDL_Window *window, int x, int y, int width,
                         int height, int colorBits, bool loop,
                         string pluginsPath, bool verboseEnabled)
    : ctxPtr(NULL) {
...
VideoPlayer::~VideoPlayer() { cleanupPlayer(); }
...
bool VideoPlayer::initPlayer(string mediaURL) {
  ...
  ctxPtr->vlc_argv.push_back(
      ctxPtr->vlc_argv_str[ctxPtr->vlc_argv_str.size() - 1].c_str());
#endif
  ...
  if (verboseEnabled)
    ctxPtr->vlc_argv.push_back("--verbose=2");
  if (verboseEnabled)
    ctxPtr->vlc_argv.push_back("--extraintf=logger"); // log anything
#if defined(WIN32)
  if (verboseEnabled)
    _putenv("VLC_VERBOSE=2");
#endif
...
//	int vlc_argc = sizeof(vlc_argv) / sizeof(*vlc_argv);
  ...
  ctxPtr->empty =
      SDL_CreateRGBSurface(SDL_SWSURFACE, width, height, colorBits, 0, 0, 0, 0);
  ctxPtr->surf = SDL_CreateRGBSurface(SDL_SWSURFACE, width, height, colorBits,
  ...
  if (verboseEnabled)
    printf("In [%s] Line: %d, libvlc [%p]\n", __FUNCTION__, __LINE__,
           ctxPtr->libvlc);

  /* It is meaningless to try all this because we have to restart mg to pickup
  new env vars #if defined(WIN32) if(libvlc == NULL) {
                  // For windows check registry for install path
                  std::string strValue = getRegKey("Software\\VideoLAN\\VLC",
  "InstallDir"); if(strValue != "") { if(strValue.length() >= 2) {
                                  if(strValue[0] == '"') {
  ...
  strValue.erase(strValue.length()-1);
                          ...
                          if(verboseEnabled) printf("Trying
  [%s]\n",getenv("VLC_PLUGIN_PATH")); libvlc = libvlc_new(vlc_argc,
  &vlc_argv[0]);
                  }

                  if(libvlc == NULL) {
                          _putenv("VLC_PLUGIN_PATH=c:\\program
  ...
  &vlc_argv[0]);
                  ...
                  if(libvlc == NULL) {
                          _putenv("VLC_PLUGIN_PATH=\\program
  files\\videolan\\vlc\\plugins");
  ...
  &vlc_argv[0]);
                  ...
                  if(libvlc == NULL) {
                          _putenv("VLC_PLUGIN_PATH=c:\\program files
  ...
  &vlc_argv[0]);
                  ...
                  if(libvlc == NULL) {
                          _putenv("VLC_PLUGIN_PATH=\\program files
  (x86)\\videolan\\vlc\\plugins");
  ...
  if (ctxPtr->libvlc != NULL) {
    ...
    if (mediaURL.find(HTTP_PREFIX) == 0) {
      libvlc_event_manager_t *eventManager =
          libvlc_media_list_player_event_manager(ctxPtr->mlp);

      if (eventManager) {
        //				libvlc_event_attach(eventManager,
        // libvlc_MediaPlayerPlaying, (libvlc_callback_t)trapPlayingEvent, NULL,
        //&ex); 				libvlc_event_attach(eventManager,
        //libvlc_MediaPlayerEndReached, (libvlc_callback_t)trapEndReachedEvent,
        //NULL, &ex); 				libvlc_event_attach(eventManager,
        // libvlc_MediaPlayerBuffering, (libvlc_callback_t)trapBufferingEvent,
        // NULL, &ex); libvlc_event_attach(eventManager,
        // libvlc_MediaPlayerEncounteredError,
        // (libvlc_callback_t)trapErrorEvent, NULL, &ex);

        int event_added = libvlc_event_attach(
            eventManager, libvlc_MediaListPlayerNextItemSet, callbacks, ctxPtr);
        if (event_added != 0) {
          printf(
              "ERROR CANNOT ADD EVENT [libvlc_MediaListPlayerNextItemSet]\n");
        }
      }
    }
    // else {
    // libvlc_event_manager_t *eventManager =
    // libvlc_media_player_event_manager(mp, &ex);
    libvlc_event_manager_t *eventManager =
        libvlc_media_player_event_manager(ctxPtr->mp);
    if (eventManager) {
      int event_added = libvlc_event_attach(
          eventManager, libvlc_MediaPlayerSnapshotTaken, callbacks, ctxPtr);
      if (event_added != 0) {
        printf("ERROR CANNOT ADD EVENT [libvlc_MediaPlayerSnapshotTaken]\n");
      }
      //				event_added = libvlc_event_attach(
      // eventManager, libvlc_MediaPlayerTimeChanged,     callbacks, ctxPtr );
      //				if(event_added != 0) {
      //					printf("ERROR CANNOT ADD EVENT
      //[libvlc_MediaPlayerTimeChanged]\n");
      //				}

      event_added = libvlc_event_attach(eventManager, libvlc_MediaPlayerPlaying,
                                        callbacks, ctxPtr);
      if (event_added != 0) {
        printf("ERROR CANNOT ADD EVENT [libvlc_MediaPlayerPlaying]\n");
      }

      event_added = libvlc_event_attach(eventManager, libvlc_MediaPlayerPaused,
                                        callbacks, ctxPtr);
      if (event_added != 0) {
        printf("ERROR CANNOT ADD EVENT [libvlc_MediaPlayerPaused]\n");
      }

      event_added = libvlc_event_attach(eventManager, libvlc_MediaPlayerStopped,
                                        callbacks, ctxPtr);
      if (event_added != 0) {
      ...
      event_added = libvlc_event_attach(
          eventManager, libvlc_MediaPlayerEndReached, callbacks, ctxPtr);
      if (event_added != 0) {
        printf("ERROR CANNOT ADD EVENT [libvlc_MediaPlayerEndReached]\n");
      }

      event_added = libvlc_event_attach(
          eventManager, libvlc_MediaPlayerPositionChanged, callbacks, ctxPtr);
      if (event_added != 0) {
        printf("ERROR CANNOT ADD EVENT [libvlc_MediaPlayerPositionChanged]\n");
      }

      event_added = libvlc_event_attach(
          eventManager, libvlc_MediaPlayerLengthChanged, callbacks, ctxPtr);
      if (event_added != 0) {
        printf("ERROR CANNOT ADD EVENT [libvlc_MediaPlayerLengthChanged]\n");
      }

      event_added = libvlc_event_attach(
          eventManager, libvlc_MediaPlayerEncounteredError, callbacks, ctxPtr);
      if (event_added != 0) {
        printf("ERROR CANNOT ADD EVENT [libvlc_MediaPlayerEncounteredError]\n");
      }

      event_added = libvlc_event_attach(
          eventManager, libvlc_MediaPlayerPausableChanged, callbacks, ctxPtr);
      if (event_added != 0) {
        printf("ERROR CANNOT ADD EVENT [libvlc_MediaPlayerPausableChanged]\n");
      }

      event_added = libvlc_event_attach(
          eventManager, libvlc_MediaPlayerSeekableChanged, callbacks, ctxPtr);
      if (event_added != 0) {
        printf("ERROR CANNOT ADD EVENT [libvlc_MediaPlayerSeekableChanged]\n");
      }

      //				event_added = libvlc_event_attach(
      // eventManager, libvlc_MediaStateChanged, callbacks, ctxPtr );
      //				if(event_added != 0) {
      //					printf("ERROR CANNOT ADD EVENT
      ...
      //				event_added = libvlc_event_attach(
      // eventManager, libvlc_MediaParsedChanged, callbacks, ctxPtr );
      //				if(event_added != 0) {
      //					printf("ERROR CANNOT ADD EVENT
...
#if defined(LIBVLC_VERSION_PRE_2) && defined(LIBVLC_VERSION_PRE_1_1_0)
      event_added = libvlc_event_attach(eventManager, libvlc_MediaPlayerVout,
                                        callbacks, ctxPtr);
      if (event_added != 0) {
      ...
      //				event_added = libvlc_event_attach(
      // eventManager, libvlc_MediaListItemAdded, callbacks, ctxPtr );
      //				if(event_added != 0) {
      //					printf("ERROR CANNOT ADD EVENT
      ...
      //
      //				event_added = libvlc_event_attach(
      // eventManager, libvlc_MediaListWillAddItem, callbacks, ctxPtr );
      //				if(event_added != 0) {
      //					printf("ERROR CANNOT ADD EVENT
      ...
      //
      //				event_added = libvlc_event_attach(
      // eventManager, libvlc_MediaListItemDeleted, callbacks, ctxPtr );
      //				if(event_added != 0) {
      //					printf("ERROR CANNOT ADD EVENT
      ...
      //
      //				event_added = libvlc_event_attach(
      // eventManager, libvlc_MediaListWillDeleteItem, callbacks, ctxPtr );
      //				if(event_added != 0) {
      //					printf("ERROR CANNOT ADD EVENT
      ...
      //
      //				event_added = libvlc_event_attach(
      // eventManager, libvlc_MediaListViewItemAdded, callbacks, ctxPtr );
      //				if(event_added != 0) {
      //					printf("ERROR CANNOT ADD EVENT
      ...
      //
      //				event_added = libvlc_event_attach(
      // eventManager, libvlc_MediaListViewWillAddItem, callbacks, ctxPtr );
      //				if(event_added != 0) {
      //					printf("ERROR CANNOT ADD EVENT
      ...
      //
      //				event_added = libvlc_event_attach(
      // eventManager, libvlc_MediaListViewItemDeleted, callbacks, ctxPtr );
      //				if(event_added != 0) {
      //					printf("ERROR CANNOT ADD EVENT
      ...
      //
      //				event_added = libvlc_event_attach(
      // eventManager, libvlc_MediaListViewWillDeleteItem, callbacks, ctxPtr );
      //				if(event_added != 0) {
      //					printf("ERROR CANNOT ADD EVENT
      ...
      //
      //				event_added = libvlc_event_attach(
      // eventManager, libvlc_MediaListPlayerPlayed, callbacks, ctxPtr );
      //				if(event_added != 0) {
      //					printf("ERROR CANNOT ADD EVENT
      ...
      //
      //				event_added = libvlc_event_attach(
      // eventManager, libvlc_MediaListPlayerStopped, callbacks, ctxPtr );
      //				if(event_added != 0) {
      //					printf("ERROR CANNOT ADD EVENT
      ...
      //
      //				event_added = libvlc_event_attach(
      // eventManager, libvlc_MediaDiscovererStarted, callbacks, ctxPtr );
      //				if(event_added != 0) {
      //					printf("ERROR CANNOT ADD EVENT
      ...
      //
      //				event_added = libvlc_event_attach(
      // eventManager, libvlc_MediaDiscovererEnded, callbacks, ctxPtr );
      //				if(event_added != 0) {
      //					printf("ERROR CANNOT ADD EVENT
      ...
      //
      //				event_added = libvlc_event_attach(
      // eventManager, libvlc_VlmMediaAdded, callbacks, ctxPtr );
      // if(event_added
      //!= 0) { 					printf("ERROR CANNOT ADD
      //!EVENT [libvlc_VlmMediaAdded]\n");
      //				}
      //
      //				event_added = libvlc_event_attach(
      // eventManager, libvlc_VlmMediaRemoved, callbacks, ctxPtr );
      //				if(event_added != 0) {
      //					printf("ERROR CANNOT ADD EVENT
      ...
      //
      //				event_added = libvlc_event_attach(
      // eventManager, libvlc_VlmMediaChanged, callbacks, ctxPtr );
      //				if(event_added != 0) {
      //					printf("ERROR CANNOT ADD EVENT
      ...
      //
      //				event_added = libvlc_event_attach(
      // eventManager, libvlc_VlmMediaInstanceStarted, callbacks, ctxPtr );
      //				if(event_added != 0) {
      //					printf("ERROR CANNOT ADD EVENT
      ...
      //
      //				event_added = libvlc_event_attach(
      // eventManager, libvlc_VlmMediaInstanceStopped, callbacks, ctxPtr );
      //				if(event_added != 0) {
      //					printf("ERROR CANNOT ADD EVENT
      ...
      //
      //				event_added = libvlc_event_attach(
      // eventManager, libvlc_VlmMediaInstanceStatusInit, callbacks, ctxPtr );
      //				if(event_added != 0) {
      //					printf("ERROR CANNOT ADD EVENT
      ...
      //
      //				event_added = libvlc_event_attach(
      // eventManager, libvlc_VlmMediaInstanceStatusOpening, callbacks, ctxPtr
      // ); 				if(event_added != 0) { 					printf("ERROR CANNOT ADD EVENT
      //[libvlc_VlmMediaInstanceStatusOpening]\n");
      //				}
      //
      //				event_added = libvlc_event_attach(
      // eventManager, libvlc_VlmMediaInstanceStatusPlaying, callbacks, ctxPtr
      // ); 				if(event_added != 0) { 					printf("ERROR CANNOT ADD EVENT
      //[libvlc_VlmMediaInstanceStatusPlaying]\n");
      //				}
      //
      //				event_added = libvlc_event_attach(
      // eventManager, libvlc_VlmMediaInstanceStatusPause, callbacks, ctxPtr );
      //				if(event_added != 0) {
      //					printf("ERROR CANNOT ADD EVENT
      ...
      //
      //				event_added = libvlc_event_attach(
      // eventManager, libvlc_VlmMediaInstanceStatusEnd, callbacks, ctxPtr );
      //				if(event_added != 0) {
      //					printf("ERROR CANNOT ADD EVENT
      ...
      //
      //				event_added = libvlc_event_attach(
      // eventManager, libvlc_VlmMediaInstanceStatusError, callbacks, ctxPtr );
      //				if(event_added != 0) {
      //					printf("ERROR CANNOT ADD EVENT
    ...
    libvlc_video_set_format(ctxPtr->mp, "RV16", width, height,
                            SDL_GetWindowSurface(this->window)->pitch);
    ...
    // SDL_Delay(5);
    if (verboseEnabled)
      printf("In [%s] Line: %d, play_result [%d]\n", __FUNCTION__, __LINE__,
             play_result);
  ...
  if (result == true) {
    ...
    for (; difftime(time(NULL), waitStart) <= MAX_VIDEO_START_MILLISECONDS &&
      ...
      if (this->loadingCB != NULL) {
        int progress = (int)((difftime(time(NULL), waitStart) /
                              MAX_VIDEO_START_MILLISECONDS) *
                             100.0);
...
void VideoPlayer::PlayVideo() {
  ...
  //	}
      ...
      //  Initialise libVLC
          ...
          if(verboseEnabled) vlc_argv.push_back("--extraintf=logger"); //log
  anything #if defined(WIN32) if(verboseEnabled) _putenv("VLC_VERBOSE=2");
  #endif
  ...
  //	int vlc_argc = sizeof(vlc_argv) / sizeof(*vlc_argv);
          ...
          if(verboseEnabled) printf("In [%s] Line: %d, libvlc
  ...
  //
          ...
          if(libvlc != NULL) {
                  ...
                  if(verboseEnabled) printf("In [%s] Line: %d, m
  [%p]\n",__FUNCTION__,__LINE__,m);

                  catchError(&ex);
                  mp = libvlc_media_player_new_from_media(m);
                  if(verboseEnabled) printf("In [%s] Line: %d, mp
  [%p]\n",__FUNCTION__,__LINE__,mp); #else
                  // Create a new item
  ...
  [%p]\n",__FUNCTION__,__LINE__,m);
                  ...
                  mp = libvlc_media_player_new_from_media(m);
                  if(verboseEnabled) printf("In [%s] Line: %d, mp
  [%p]\n",__FUNCTION__,__LINE__,mp); #endif libvlc_media_release(m);

  #if !defined(LIBVLC_VERSION_PRE_2) && !defined(LIBVLC_VERSION_PRE_1_1_0)
                  libvlc_video_set_callbacks(mp, lock, unlock, display, ctxPtr);
                  libvlc_video_set_format(mp, "RV16", width, height,
  this->window->pitch);

                  // Get an event manager for the media player.
                  //libvlc_event_manager_t *eventManager =
  libvlc_media_player_event_manager(mp, &ex); libvlc_event_manager_t
  *eventManager = libvlc_media_player_event_manager(mp); if(eventManager) {
  //			libvlc_event_attach(eventManager,
  libvlc_MediaPlayerPlaying, (libvlc_callback_t)trapPlayingEvent, NULL, &ex);
  //			libvlc_event_attach(eventManager,
  libvlc_MediaPlayerEndReached, (libvlc_callback_t)trapEndReachedEvent, NULL,
  &ex);
  //			libvlc_event_attach(eventManager,
  libvlc_MediaPlayerBuffering, (libvlc_callback_t)trapBufferingEvent, NULL,
  &ex);
  //			libvlc_event_attach(eventManager,
  libvlc_MediaPlayerEncounteredError, (libvlc_callback_t)trapErrorEvent, NULL,
  &ex); libvlc_event_attach(eventManager, libvlc_MediaPlayerPlaying,
  (libvlc_callback_t)trapPlayingEvent, ctxPtr);
                          libvlc_event_attach(eventManager,
  libvlc_MediaPlayerEndReached, (libvlc_callback_t)trapEndReachedEvent, ctxPtr);
                          libvlc_event_attach(eventManager,
  libvlc_MediaPlayerBuffering, (libvlc_callback_t)trapBufferingEvent, ctxPtr);
                          libvlc_event_attach(eventManager,
  libvlc_MediaPlayerEncounteredError, (libvlc_callback_t)trapErrorEvent,
  ctxPtr);
                  }
  #endif
                  ...
                  //SDL_Delay(5);
                  if(verboseEnabled) printf("In [%s] Line: %d, play_result
...
bool VideoPlayer::isPlaying() const {
  bool result = (successLoadingLib == true && ctxPtr != NULL &&
                 ctxPtr->isPlaying == true &&
                 // ctxPtr->error == false &&
                 (ctxPtr->error == false || ctxPtr->stopped == false) &&
  ...
  if (ctxPtr != NULL && ctxPtr->verboseEnabled)
    printf("isPlaying isPlaying = %d,error = %d, stopped = %d, end_of_media = "
           "%d\n",
           ctxPtr->isPlaying, ctxPtr->error, ctxPtr->stopped,
           ctxPtr->end_of_media);
  return result;
}
...
bool VideoPlayer::playFrame(bool swapBuffers) {
  ...
  if (successLoadingLib == true && ctxPtr != NULL &&
      ctxPtr->isPlaying == true && finished == false && stop == false) {
    ...
    if (finished == false && stop == false) {
      ...
      if (ctxPtr->x == -1 || ctxPtr->y == -1) {
        ...
        const double HEIGHT_MULTIPLIER =
            HEIGHT_DEFAULT / (double)ctxPtr->height;
        ...
        glTexCoord2i(0, 1);
        glVertex2i(ctxPtr->x, (int)((double)ctxPtr->y + (double)ctxPtr->height *
                                                            HEIGHT_MULTIPLIER));
        glTexCoord2i(0, 0);
        glVertex2i(ctxPtr->x, ctxPtr->y);
        glTexCoord2i(1, 1);
        glVertex2i(
            (int)((double)ctxPtr->x + (double)ctxPtr->width * WIDTH_MULTIPLIER),
            (int)((double)ctxPtr->y +
                  (double)ctxPtr->height * HEIGHT_MULTIPLIER));
        glTexCoord2i(1, 0);
        glVertex2i(
            (int)((double)ctxPtr->x + (double)ctxPtr->width * WIDTH_MULTIPLIER),
            ctxPtr->y);
