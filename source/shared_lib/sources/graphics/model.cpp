...
void fromEndianFileHeader(FileHeader &header) {
  ...
  if (bigEndianSystem == true) {
    ...
    header.version =
        Shared::PlatformByteOrder::fromCommonEndian(header.version);
  }
}
...
void toEndianModelHeader(ModelHeader &header) {
  ...
  if (bigEndianSystem == true) {
    ...
    header.meshCount =
        Shared::PlatformByteOrder::toCommonEndian(header.meshCount);
  }
}
...
void toEndianMeshHeader(MeshHeader &header) {
  ...
  if (bigEndianSystem == true) {
    for (unsigned int i = 0; i < meshNameSize; ++i) {
      header.name[i] =
          Shared::PlatformByteOrder::toCommonEndian(header.name[i]);
    }
    header.frameCount =
        Shared::PlatformByteOrder::toCommonEndian(header.frameCount);
    header.vertexCount =
        Shared::PlatformByteOrder::toCommonEndian(header.vertexCount);
    header.indexCount =
        Shared::PlatformByteOrder::toCommonEndian(header.indexCount);
    for (unsigned int i = 0; i < 3; ++i) {
      header.diffuseColor[i] =
          Shared::PlatformByteOrder::toCommonEndian(header.diffuseColor[i]);
      header.specularColor[i] =
          Shared::PlatformByteOrder::toCommonEndian(header.specularColor[i]);
    }
    header.specularPower =
        Shared::PlatformByteOrder::toCommonEndian(header.specularPower);
    header.opacity = Shared::PlatformByteOrder::toCommonEndian(header.opacity);
    header.properties =
        Shared::PlatformByteOrder::toCommonEndian(header.properties);
    header.textures =
        Shared::PlatformByteOrder::toCommonEndian(header.textures);
  }
}
...
void fromEndianMeshHeader(MeshHeader &header) {
  ...
  if (bigEndianSystem == true) {
    for (unsigned int i = 0; i < meshNameSize; ++i) {
      header.name[i] =
          Shared::PlatformByteOrder::fromCommonEndian(header.name[i]);
    }
    header.frameCount =
        Shared::PlatformByteOrder::fromCommonEndian(header.frameCount);
    header.vertexCount =
        Shared::PlatformByteOrder::fromCommonEndian(header.vertexCount);
    header.indexCount =
        Shared::PlatformByteOrder::fromCommonEndian(header.indexCount);
    for (unsigned int i = 0; i < 3; ++i) {
      header.diffuseColor[i] =
          Shared::PlatformByteOrder::fromCommonEndian(header.diffuseColor[i]);
      header.specularColor[i] =
          Shared::PlatformByteOrder::fromCommonEndian(header.specularColor[i]);
    }
    header.specularPower =
        Shared::PlatformByteOrder::fromCommonEndian(header.specularPower);
    header.opacity =
        Shared::PlatformByteOrder::fromCommonEndian(header.opacity);
    header.properties =
        Shared::PlatformByteOrder::fromCommonEndian(header.properties);
    header.textures =
        Shared::PlatformByteOrder::fromCommonEndian(header.textures);
  }
}
...
void fromEndianModelHeaderV3(ModelHeaderV3 &header) {
  ...
  if (bigEndianSystem == true) {
    header.meshCount =
        Shared::PlatformByteOrder::fromCommonEndian(header.meshCount);
  }
}
...
void toEndianMeshHeaderV3(MeshHeaderV3 &header) {
  static bool bigEndianSystem = Shared::PlatformByteOrder::isBigEndian();
  if (bigEndianSystem == true) {
    header.vertexFrameCount =
        Shared::PlatformByteOrder::toCommonEndian(header.vertexFrameCount);
    header.normalFrameCount =
        Shared::PlatformByteOrder::toCommonEndian(header.normalFrameCount);
    header.texCoordFrameCount =
        Shared::PlatformByteOrder::toCommonEndian(header.texCoordFrameCount);
    header.colorFrameCount =
        Shared::PlatformByteOrder::toCommonEndian(header.colorFrameCount);
    header.pointCount =
        Shared::PlatformByteOrder::toCommonEndian(header.pointCount);
    header.indexCount =
        Shared::PlatformByteOrder::toCommonEndian(header.indexCount);
    header.properties =
        Shared::PlatformByteOrder::toCommonEndian(header.properties);
    for (unsigned int i = 0; i < 64; ++i) {
      header.texName[i] =
          Shared::PlatformByteOrder::toCommonEndian(header.texName[i]);
    }
  }
}
...
void fromEndianMeshHeaderV3(MeshHeaderV3 &header) {
  ...
  if (bigEndianSystem == true) {
    header.vertexFrameCount =
        Shared::PlatformByteOrder::fromCommonEndian(header.vertexFrameCount);
    header.normalFrameCount =
        Shared::PlatformByteOrder::fromCommonEndian(header.normalFrameCount);
    header.texCoordFrameCount =
        Shared::PlatformByteOrder::fromCommonEndian(header.texCoordFrameCount);
    header.colorFrameCount =
        Shared::PlatformByteOrder::fromCommonEndian(header.colorFrameCount);
    header.pointCount =
        Shared::PlatformByteOrder::fromCommonEndian(header.pointCount);
    header.indexCount =
        Shared::PlatformByteOrder::fromCommonEndian(header.indexCount);
    header.properties =
        Shared::PlatformByteOrder::fromCommonEndian(header.properties);
    for (unsigned int i = 0; i < 64; ++i) {
      header.texName[i] =
          Shared::PlatformByteOrder::fromCommonEndian(header.texName[i]);
    }
  }
}
...
void toEndianMeshHeaderV2(MeshHeaderV2 &header) {
  ...
  if (bigEndianSystem == true) {
    ...
    header.indexCount =
        Shared::PlatformByteOrder::toCommonEndian(header.indexCount);
    header.hasTexture =
        Shared::PlatformByteOrder::toCommonEndian(header.hasTexture);
    header.primitive =
        Shared::PlatformByteOrder::toCommonEndian(header.primitive);
    header.cullFace =
        Shared::PlatformByteOrder::toCommonEndian(header.cullFace);
...
void fromEndianMeshHeaderV2(MeshHeaderV2 &header) {
  ...
  if (bigEndianSystem == true) {
    ...
    header.indexCount =
        Shared::PlatformByteOrder::fromCommonEndian(header.indexCount);
    header.hasTexture =
        Shared::PlatformByteOrder::fromCommonEndian(header.hasTexture);
    header.primitive =
        Shared::PlatformByteOrder::fromCommonEndian(header.primitive);
    header.cullFace =
        Shared::PlatformByteOrder::fromCommonEndian(header.cullFace);
...
void Mesh::init() {
  try {
    ...
    snprintf(szBuf, 8096, "Error on line: %d size: %d msg: %s\n", __LINE__,
             (frameCount * vertexCount), ba.what());
...
void Mesh::BuildVBOs() {
  if (getVBOSupported() == true) {
    if (hasBuiltVBOs == false) {
      // printf("In [%s::%s Line: %d] setting up a
      ...
      glBufferDataARB(GL_ARRAY_BUFFER_ARB,
                      sizeof(Vec3f) * frameCount * vertexCount, vertices,
                      GL_STATIC_DRAW_ARB);
      ...
      // Load The Data
      glBufferDataARB(GL_ARRAY_BUFFER_ARB, sizeof(Vec2f) * vertexCount,
      ...
      // Load The Data
      glBufferDataARB(GL_ARRAY_BUFFER_ARB,
                      sizeof(Vec3f) * frameCount * vertexCount, normals,
                      GL_STATIC_DRAW_ARB);
      glBindBufferARB(GL_ARRAY_BUFFER_ARB, 0);
      ...
      // Load The Data
      glBufferDataARB(GL_ELEMENT_ARRAY_BUFFER_ARB, sizeof(uint32) * indexCount,
...
string Mesh::findAlternateTexture(vector<string> conversionList,
                                  string textureFile) {
...
void Mesh::loadV2(
    int meshIndex, const string &dir, FILE *f, TextureManager *textureManager,
  ...
  if (readBytes != 1) {
    char szBuf[8096] = "";
    snprintf(szBuf, 8096,
             "fread returned wrong size = " MG_SIZE_T_SPECIFIER " on line: %d.",
             readBytes, __LINE__);
    throw megaglest_runtime_error(szBuf);
  }
  ...
  if (meshHeader.normalFrameCount != meshHeader.vertexFrameCount) {
    char szBuf[8096] = "";
    snprintf(szBuf, 8096,
             "Old v2 model: vertex frame count different from normal frame "
             "count [v = %d, n = %d] meshIndex = %d modelFile [%s]",
             meshHeader.vertexFrameCount, meshHeader.normalFrameCount,
             meshIndex, modelFile.c_str());
  ...
  if (meshHeader.texCoordFrameCount != 1) {
    char szBuf[8096] = "";
    snprintf(szBuf, 8096,
             "Old v2 model: texture coord frame count is not 1 [t = %d] "
             "meshIndex = %d modelFile [%s]",
             meshHeader.texCoordFrameCount, meshIndex, modelFile.c_str());
    throw megaglest_runtime_error(szBuf, true);
  }
  ...
  if (SystemFlags::VERBOSE_MODE_ENABLED)
    printf(
        "Load v2, this = %p Found meshHeader.hasTexture = %d, texName [%s] "
        "mtDiffuse = %d meshIndex = %d modelFile [%s]\n",
        this, meshHeader.hasTexture,
        toLower(reinterpret_cast<char *>(meshHeader.texName)).c_str(),
        mtDiffuse, meshIndex, modelFile.c_str());
  ...
  if (meshHeader.hasTexture && textureManager != NULL) {
    texturePaths[mtDiffuse] =
        toLower(reinterpret_cast<char *>(meshHeader.texName));
    string texPath = dir;
    if (texPath != "") {
    ...
    if (SystemFlags::VERBOSE_MODE_ENABLED)
      printf(
          "In [%s::%s Line: %d] v2 model texture [%s] meshIndex = %d modelFile "
          "[%s]\n",
          extractFileFromDirectoryPath(__FILE__).c_str(), __FUNCTION__,
          __LINE__, texPath.c_str(), meshIndex, modelFile.c_str());

    textures[mtDiffuse] =
        dynamic_cast<Texture2D *>(textureManager->getTexture(texPath));
    if (textures[mtDiffuse] == NULL) {
      ...
      if (fileExists(texPath) == true) {
        if (SystemFlags::VERBOSE_MODE_ENABLED)
          printf(
              "In [%s::%s Line: %d] v2 model texture [%s] meshIndex = %d "
              "modelFile [%s]\n",
              extractFileFromDirectoryPath(__FILE__).c_str(), __FUNCTION__,
              __LINE__, texPath.c_str(), meshIndex, modelFile.c_str());
        ...
        if (loadedFileList) {
          (*loadedFileList)[texPath].push_back(
              make_pair(sourceLoader, sourceLoader));
        }
        texturesOwned[mtDiffuse] = true;
        textures[mtDiffuse]->init(textureManager->getTextureFilter(),
                                  textureManager->getMaxAnisotropy());
        ...
        SystemFlags::OutputDebug(
            ...
            "In [%s::%s Line: %d] Error v2 model is missing texture [%s] "
            "meshIndex = %d modelFile [%s]\n",
            extractFileFromDirectoryPath(__FILE__).c_str(), __FUNCTION__,
            __LINE__, texPath.c_str(), meshIndex, modelFile.c_str());
      }
  ...
  if (readBytes != 1 && (frameCount * vertexCount) != 0) {
    char szBuf[8096] = "";
    snprintf(szBuf, 8096,
             "fread returned wrong size = " MG_SIZE_T_SPECIFIER
             " [%u][%u] on line: %d.",
             readBytes, frameCount, vertexCount, __LINE__);
    throw megaglest_runtime_error(szBuf);
  }
  ...
  if (seek_result != 0) {
    char szBuf[8096] = "";
    snprintf(szBuf, 8096, "fseek returned failure = %d [%u] on line: %d.",
             seek_result, indexCount, __LINE__);
    throw megaglest_runtime_error(szBuf);
  }
...
void Mesh::loadV3(
  ...
  if (meshHeader.normalFrameCount != meshHeader.vertexFrameCount) {
    char szBuf[8096] = "";
    snprintf(szBuf, 8096,
             "Old v3 model: vertex frame count different from normal frame "
             "count [v = %d, n = %d] meshIndex = %d modelFile [%s]",
             meshHeader.vertexFrameCount, meshHeader.normalFrameCount,
             meshIndex, modelFile.c_str());
    throw megaglest_runtime_error(szBuf, true);
  ...
  if (SystemFlags::VERBOSE_MODE_ENABLED)
    printf(
        "Load v3, this = %p Found meshHeader.properties = %d, textureFlags = "
        "%d, texName [%s] mtDiffuse = %d meshIndex = %d modelFile [%s]\n",
        this, meshHeader.properties, textureFlags,
        toLower(reinterpret_cast<char *>(meshHeader.texName)).c_str(),
        mtDiffuse, meshIndex, modelFile.c_str());
  ...
  if ((meshHeader.properties & mp3NoTexture) != mp3NoTexture &&
    ...
    if (SystemFlags::VERBOSE_MODE_ENABLED)
      printf(
          "In [%s::%s Line: %d] v3 model texture [%s] meshIndex = %d modelFile "
          "[%s]\n",
          extractFileFromDirectoryPath(__FILE__).c_str(), __FUNCTION__,
          __LINE__, texPath.c_str(), meshIndex, modelFile.c_str());
    ...
    if (textures[mtDiffuse] == NULL) {
      ...
      if (fileExists(texPath) == true) {
        if (SystemFlags::VERBOSE_MODE_ENABLED)
          printf(
              "In [%s::%s Line: %d] v3 model texture [%s] meshIndex = %d "
              "modelFile [%s]\n",
              extractFileFromDirectoryPath(__FILE__).c_str(), __FUNCTION__,
              __LINE__, texPath.c_str(), meshIndex, modelFile.c_str());
        ...
        SystemFlags::OutputDebug(
            SystemFlags::debugError,
            "In [%s::%s Line: %d] Error v3 model is missing texture [%s] "
            "meshHeader.properties = %d meshIndex = %d modelFile [%s]\n",
            extractFileFromDirectoryPath(__FILE__).c_str(), __FUNCTION__,
            __LINE__, texPath.c_str(), meshHeader.properties, meshIndex,
            modelFile.c_str());
      }
    }
  }
...
Texture2D *Mesh::loadMeshTexture(
  ...
  if (SystemFlags::VERBOSE_MODE_ENABLED)
    printf("In [%s] #1 load texture [%s] modelFile [%s]\n", __FUNCTION__,
           textureFile.c_str(), modelFile.c_str());

  Texture2D *texture =
      dynamic_cast<Texture2D *>(textureManager->getTexture(textureFile));
  if (texture == NULL) {
    ...
    if (fileExists(textureFile) == true) {
      if (SystemFlags::VERBOSE_MODE_ENABLED)
        printf("In [%s] #3 load texture [%s] modelFile [%s]\n", __FUNCTION__,
               textureFile.c_str(), modelFile.c_str());
      // if(SystemFlags::VERBOSE_MODE_ENABLED) printf("In [%s] texture exists
      ...
      if (loadedFileList) {
        (*loadedFileList)[textureFile].push_back(
            make_pair(sourceLoader, sourceLoader));
      }

      // if(SystemFlags::VERBOSE_MODE_ENABLED) printf("In [%s] texture loaded
      // [%s]\n",__FUNCTION__,textureFile.c_str());

      textureOwned = true;
      texture->init(textureManager->getTextureFilter(),
                    textureManager->getMaxAnisotropy());
      if (deletePixMapAfterLoad == true) {
        texture->deletePixels();
      }

      // if(SystemFlags::VERBOSE_MODE_ENABLED) printf("In [%s] texture inited
      // [%s]\n",__FUNCTION__,textureFile.c_str());
    } else {
      if (SystemFlags::VERBOSE_MODE_ENABLED)
        printf("In [%s] #3 cannot load texture [%s] modelFile [%s]\n",
               __FUNCTION__, textureFile.c_str(), modelFile.c_str());
      SystemFlags::OutputDebug(
          SystemFlags::debugError,
          "In [%s::%s Line: %d] Error v4 model is missing texture [%s] "
          "textureFlags = %d meshIndex = %d textureIndex = %d modelFile [%s]\n",
          extractFileFromDirectoryPath(__FILE__).c_str(), __FUNCTION__,
          __LINE__, textureFile.c_str(), textureFlags, meshIndex, textureIndex,
          modelFile.c_str());
    }
  }
...
void Mesh::load(
  ...
  // printf("Load, Found meshTextureCount = %d, meshHeader.textures =
  ...
  if (opacity == 0) {
    if (SystemFlags::VERBOSE_MODE_ENABLED)
      printf(
          "found a mesh with opacity=0 in header, using opacity=1 to see it "
          "now \n");
    if (SystemFlags::VERBOSE_MODE_ENABLED)
      printf("file: %s\n", modelFile.c_str());
    opacity = 1.0f;
    ...
    if (meshHeader.textures & flag) {
      ...
      if (readBytes != 1 && mapPathSize != 0) {
        ...
        snprintf(szBuf, 8096,
                 "fread returned wrong size = " MG_SIZE_T_SPECIFIER
                 " [%u] on line: %d.",
                 readBytes, mapPathSize, __LINE__);
        throw megaglest_runtime_error(szBuf);
      }
      Shared::PlatformByteOrder::fromEndianTypeArray<uint8>(cMapPath,
                                                            mapPathSize);

      char mapPathString[mapPathSize + 1] = "";
      memset(&mapPathString[0], 0, mapPathSize + 1);
      memcpy(&mapPathString[0], reinterpret_cast<char *>(cMapPath),
             mapPathSize);
      ...
      // its a workaround for broken mods made by windows users ( filenames  are
      // not case sensitive in windows  ) This allows us to fix mods with bad
      // cases by renaming all texture filesnames to lower case. By this mods
      // work in linux too.
      ...
      if (SystemFlags::VERBOSE_MODE_ENABLED)
        printf(
            "mapPath [%s] meshHeader.textures = %d flag = %d "
            "(meshHeader.textures & flag) = %d meshIndex = %d i = %d\n",
            mapPath.c_str(), meshHeader.textures, flag,
            (meshHeader.textures & flag), meshIndex, i);
      ...
      if (textureManager) {
        textures[i] = loadMeshTexture(meshIndex, i, textureManager, mapFullPath,
                                      ...
                                      texturesOwned[i], deletePixMapAfterLoad,
                                      loadedFileList, sourceLoader, modelFile);
      }
    }
    flag *= 2;
  }
...
void Mesh::save(int meshIndex, const string &dir, FILE *f,
  ...
  // material
  memcpy((float32 *)meshHeader.diffuseColor, (float32 *)diffuseColor.ptr(),
         sizeof(float32) * 3);
  memcpy((float32 *)meshHeader.specularColor, (float32 *)specularColor.ptr(),
         sizeof(float32) * 3);
  ...
  if (SystemFlags::VERBOSE_MODE_ENABLED)
    printf(
        "Save, this = %p, Found meshTextureCount = %d, meshHeader.textures = "
        "%d meshIndex = %d\n",
  ...
  for (int i = 0; i < meshTextureCount; ++i) {
    if ((meshHeader.textures & flag)) {
      ...
      if (SystemFlags::VERBOSE_MODE_ENABLED)
        printf("Save, [%d] mesh texture ptr [%p]\n", i, texture);

      if (texture != NULL) {
        string file = toLower(texture->getPath());

        if (SystemFlags::VERBOSE_MODE_ENABLED)
          printf("Save, Found mesh texture [%s]\n", file.c_str());
        ...
        if (toLower(convertTextureToFormat) != "" &&
          ...
          if (SystemFlags::VERBOSE_MODE_ENABLED)
            printf("Save, Convert from [%s] to [%s]\n",
          ...
          if (convertTextureToFormat == "tga") {
            ...
            if (keepsmallest == false || newSize <= originalSize) {
              textureDeleteList[texture->getPath()] =
                  textureDeleteList[texture->getPath()] + 1;
            } else {
              printf(
                  "Texture will not be converted, keeping smallest texture "
                  "[%s]\n",
            ...
            throw megaglest_runtime_error("Unsupported texture format: [" +
          ...
          if (SystemFlags::VERBOSE_MODE_ENABLED)
            printf(
                "Save, load new texture [%s] originalSize [%ld] newSize "
                "[%ld]\n",
                file.c_str(), originalSize, newSize);

          if (keepsmallest == false || newSize <= originalSize) {
            texture = loadMeshTexture(
                meshIndex, i, textureManager, file, meshTextureChannelCount[i],
                texturesOwned[i], false, NULL, "", modelFile);
          }
        }
        ...
        if (file.length() > mapPathSize) {
          throw megaglest_runtime_error(
              "file.length() > mapPathSize, file.length() = " +
              intToStr(file.length()));
...
void Mesh::computeTangents() {
  ...
  for (unsigned int i = 0; i < indexCount; i += 3) {
    for (int j = 0; j < 3; ++j) {
      ...
      tangents[i0] += ((p2 - p0) * (v1 - v0) - (p1 - p0) * (v2 - v0)) /
...
void Model::load(
  ...
  if (extension == "g3d") {
    ...
    throw megaglest_runtime_error("#1 Unknown model format [" + extension +
                                  "] file [" + path + "]");
  }
}
...
void Model::save(const string &path, string convertTextureToFormat,
                 bool keepsmallest) {
  string extension =
      (path.empty() == false ? path.substr(path.find_last_of('.') + 1) : "");
  if (toLower(extension) == "g3d") {
    saveG3d(path, convertTextureToFormat, keepsmallest);
  } else {
    throw megaglest_runtime_error("#2 Unknown model format [" + extension +
                                  "] file [" + path + "]");
  }
}
  ...
  try {
    ...
    if (f == NULL) {
      printf("In [%s::%s] cannot load file = [%s]\n",
             ...
             path.c_str());
      throw megaglest_runtime_error(
          "Error opening g3d model file [" + path + "]", true);
    }
    ...
    // version 2
      ...
      throw megaglest_runtime_error("Invalid model version: " +
                                    intToStr(fileHeader.version));
    }
    ...
    // printf("2222222\n");
    throw megaglest_runtime_error(
        "Exception caught loading 3d file: " + path + "\n" + ex.what(),
        !ex.wantStackTrace());
  } catch (exception &e) {
    // abort();
    SystemFlags::OutputDebug(SystemFlags::debugError,
...
void Model::saveG3d(const string &path, string convertTextureToFormat,
...
#endif
  if (f == NULL) {
    throw megaglest_runtime_error("Cant open file for writing: [" +
                                  tempModelFilename + "]");
  }
  ...
  // file versions
  if (fileHeader.version == 4 || fileHeader.version == 3 ||
    ...
    for (uint32 i = 0; i < meshCount; ++i) {
      meshes[i].save(i, tempModelFilename, f, textureManager,
                     convertTextureToFormat, textureDeleteList, keepsmallest,
                     path);
    }
...
class MeshContainer {
 ...
 public:
  MeshContainer() { this->indexValue = -1; }
  ...
  int index() { return indexValue; }
  int size() { return (int)meshes.size(); }
...
void Mesh::copyInto(Mesh *dest, bool ignoreInterpolationData,
  ...
  if (this->vertices != NULL) {
    ...
    memcpy(&dest->vertices[0], &this->vertices[0],
           this->frameCount * this->vertexCount * sizeof(Vec3f));
  }
  ...
  if (this->normals != NULL) {
    ...
    memcpy(&dest->normals[0], &this->normals[0],
           this->frameCount * this->vertexCount * sizeof(Vec3f));
  }
  ...
  if (this->texCoords != NULL) {
    ...
    memcpy(&dest->texCoords[0], &this->texCoords[0],
           this->vertexCount * sizeof(Vec2f));
  }
  ...
  if (this->tangents != NULL) {
    ...
    memcpy(&dest->tangents[0], &this->tangents[0],
           this->vertexCount * sizeof(Vec3f));
  }
  ...
  if (this->indices != NULL) {
    ...
    memcpy(&dest->indices[0], &this->indices[0],
...
void Model::autoJoinMeshFrames() {
  /*
          ...
          for mesh in self.meshes:
              key =
     (mesh.texture,mesh.frame_count,mesh.twoSided|mesh.customColour) if key in
     meshes: meshes[key].append(mesh) else: meshes[key] = [mesh] for joinable in
     meshes.values(): if len(joinable) < 2: continue base = joinable[0] print
     "\tjoining to",base for mesh in joinable[1:]: if
     base.index_count+mesh.index_count > 0xffff: base = mesh print "\tjoining
     to",base continue print "\t\t",mesh for a,b in
     zip(base.frames,mesh.frames): a.vertices.extend(b.vertices)
                      a.normals.extend(b.normals)
                  if base.texture:
                      base.textures.extend(mesh.textures)
                  base.indices.extend(index+base.vertex_count for index in
     mesh.indices) base.vertex_count += mesh.vertex_count base.index_count +=
     mesh.index_count self.meshes.remove(mesh)
  */
  ...
  for (uint32 index = 0; index < meshCount; ++index) {
    ...
    // 1. texture 2. framecount 3. twosided flag value 4. same custom texture
    // color

    //		It's possible the texture is missing and will be NULL
    //		if(mesh.getTextureFlags() & 1) {
    //			printf("Mesh has textures:\n");
    //			for(unsigned int meshTexIndex = 0; meshTexIndex <
    // meshTextureCount; ++meshTexIndex) {
    // printf("Mesh texture index: %d [%p]
    //[%s]\n",meshTexIndex,mesh.getTexture(meshTexIndex),(mesh.getTexture(meshTexIndex)
    //!= NULL ? mesh.getTexture(meshTexIndex)->getPath().c_str() : "n/a"));
    //			}
    //		}
    string mesh_key = ((mesh.getTextureFlags() & 1) && mesh.getTexture(0)
                           ? mesh.getTexture(0)->getPath()
                           : "none");
    mesh_key += string("_") + intToStr(mesh.getFrameCount()) + string("_") +
                intToStr(mesh.getTwoSided()) + string("_") +
                intToStr(mesh.getCustomTexture()) + string("_") +
                intToStr(mesh.getNoSelect()) + string("_") +
                floatToStr(mesh.getOpacity()) + string("_") +
                floatToStr(mesh.getGlow()) + string("_") +
                mesh.getDiffuseColor().getString() + string("_") +
                mesh.getSpecularColor().getString() + string("_") +
                floatToStr(mesh.getSpecularPower());
  ...
  if (haveJoinedMeshes == true) {
    ...
    int index = 0;
    for (std::map<int, std::vector<Mesh *> >::iterator iterMap =
             orderedMeshes.begin();
      ...
      if (iterMap->second.size() > 1) {
        ...
        for (unsigned int joinIndex = 1; joinIndex < iterMap->second.size();
             ++joinIndex) {
          ...
          uint32 newVertexFrameCount = (base->getFrameCount() * newVertexCount);
          ...
          for (unsigned int frameIndex = 0; frameIndex < base->getFrameCount();
               ++frameIndex) {
            ...
            memcpy(&joined_normals[join_index], &base->getNormals()[baseIndex],
                   originalBaseVertexCount * sizeof(Vec3f));
            ...
            memcpy(&joined_normals[join_index], &mesh->getNormals()[meshIndex],
                   mesh->getVertexCount() * sizeof(Vec3f));
          ...
          if (base->getTextureFlags() & 1) {
            ...
            memcpy(&joined_texCoords[0], &base->getTexCoords()[0],
          ...
          memcpy(&joined_indexes[join_index_index], &base->getIndices()[0],
                 base->getIndexCount() * sizeof(uint32));
          join_index_index += base->getIndexCount();

          for (unsigned int meshIndex = 0; meshIndex < mesh->getIndexCount();
               ++meshIndex) {
            uint32 index_value = mesh->getIndices()[meshIndex];

            // join index values
            joined_indexes[join_index_index] =
                index_value + originalBaseVertexCount;
            join_index_index++;
          }
...
Pixmap2D *PixelBufferWrapper::getPixelBufferFor(int x, int y, int w, int h,
                                                int colorComponents) {
  ...
  if (PixelBufferWrapper::isPBOEnabled == true) {
    ...
    try {
      ...
      if (index >= (int)pboIds.size()) {
        char szBuf[8096] = "";
        snprintf(szBuf, 8096,
                 "Error / Warning in [%s::%s] on line: %d pixel buffer out of "
                 "range, index: %d size: %d, attempting to expand buffer...\n",
      ...
      if (src) {
        ...
        if (SystemFlags::VERBOSE_MODE_ENABLED)
          printf("In [%s::%s Line: %d]\n",
                 extractFileFromDirectoryPath(__FILE__).c_str(), __FUNCTION__,
                 __LINE__);
        memcpy(pixmapScreenShot->getPixels(), src,
               pixmapScreenShot->getPixelByteCount());
      ...
      SystemFlags::OutputDebug(
          SystemFlags::debugError,
          "In [%s::%s Line: %d] codeSection [%s] Error [%s]\n",
          extractFileFromDirectoryPath(__FILE__).c_str(), __FUNCTION__,
          __LINE__, codeSection.c_str(), ex.what());
      throw megaglest_runtime_error(
          "Exception caught in getPixelBufferFor codeSection: " + codeSection +
              "\n" + ex.what(),
          !ex.wantStackTrace());
    } catch (exception &e) {
      SystemFlags::OutputDebug(
          ...
          "In [%s::%s Line: %d] codeSection [%s] Error [%s]\n",
          extractFileFromDirectoryPath(__FILE__).c_str(), __FUNCTION__,
          __LINE__, codeSection.c_str(), e.what());
      throw megaglest_runtime_error(
          "Exception caught in getPixelBufferFor codeSection: " + codeSection +
          "\n" + e.what());
    } catch (...) {
      SystemFlags::OutputDebug(
          SystemFlags::debugError,
          "In [%s::%s Line: %d] codeSection [%s] UNKNOWN Error!",
          extractFileFromDirectoryPath(__FILE__).c_str(), __FUNCTION__,
          __LINE__, codeSection.c_str());
      throw megaglest_runtime_error(
          "UNKNOWN Exception caught in getPixelBufferFor codeSection: " +
          codeSection + "\n");
    }
    if (SystemFlags::VERBOSE_MODE_ENABLED)
      printf("In [%s::%s Line: %d]\n",
...
PixelBufferWrapper::~PixelBufferWrapper() { cleanup(); }
...
bool BaseColorPickEntity::get_next_assign_color(unsigned char *assign_to) {
  ...
  if (BaseColorPickEntity::trackColorUse == true) {
    ...
    if (usedColorIDList.find(color_key) == usedColorIDList.end()) {
      ...
      // printf("Color added to used list [%s] usedColorIDList = %d
      // nextColorIDReuseList =
      // %d!\n",color_key.c_str(),(int)usedColorIDList.size(),(int)nextColorIDReuseList.size());
    } else {
      isDuplicate = true;
      printf(
          "Line ref: %d *WARNING* color [%s] used count: %d using_loop: %d "
          "ALREADY in history list!\n",
          __LINE__, color_key.c_str(), (int)usedColorIDList.size(),
          BaseColorPickEntity::using_loop_method);
    }
  }
  return isDuplicate;
}
...
void BaseColorPickEntity::assign_color_using_prime(unsigned char *assign_to) {
  ...
  const unsigned int r = (nextColorRGB >> 11) & ((1 << 5) - 1),
...
void BaseColorPickEntity::assign_color_using_loop(unsigned char *assign_to) {
  if (nextColorIDReuseList.empty() == false) {
    // printf("Color being reused [%u.%u.%u] usedColorIDList = %d
    // nextColorIDReuseList =
    ...
    if (usedColorIDList.find(color_key) == usedColorIDList.end()) {
      ...
      printf(
          "Line ref: %d *WARNING* color [%s] ALREADY FOUND in history list!\n",
...
void BaseColorPickEntity::recycleUniqueColor() {
  ...
  // printf("RECYCLE Color [%u.%u.%u] usedColorIDList = %d nextColorIDReuseList
  // =
  ...
  if (usedColorIDList.empty() == false) {
    ...
    // printf("REMOVING used Color [%s] usedColorIDList = %d
    // nextColorIDReuseList =
    // %d!\n",color_key.c_str(),(int)usedColorIDList.size(),(int)nextColorIDReuseList.size());
    // printf("Line ref: %d *WARNING* color [%s] used count: %d NOT FOUND in
    // history list!\n",__LINE__,color_key.c_str(),(int)usedColorIDList.size());
  }
}
...
void BaseColorPickEntity::init(int bufferSize) {
  if (BaseColorPickEntity::pbo.get() == NULL) {
    ...
    BaseColorPickEntity::pbo.reset(
        new PixelBufferWrapper(2, BaseColorPickEntity::bufferSizeRequired));
...
void BaseColorPickEntity::cleanupPBO() { BaseColorPickEntity::pbo.reset(0); }

string BaseColorPickEntity::getColorDescription() const {
  char szBuf[100] = "";
  snprintf(szBuf, 100, "%d.%d.%d", uniqueColorID[0], uniqueColorID[1],
           uniqueColorID[2]);
  string result = szBuf;
  return result;
}
...
void BaseColorPickEntity::beginPicking() {
  ...
  // glPushAttrib(GL_TEXTURE_2D | GL_LIGHTING | GL_BLEND | GL_MULTISAMPLE |
  // GL_DITHER); glPushAttrib(GL_ENABLE_BIT | GL_LIGHTING_BIT | GL_POLYGON_BIT |
  // GL_CURRENT_BIT | GL_TEXTURE_BIT | GL_NORMALIZE | GL_BLEND |
...
vector<int> BaseColorPickEntity::getPickedList(
  ...
  // printf("PixelBufferWrapper::getIsPBOEnable() =
  // %d\n",PixelBufferWrapper::getIsPBOEnable());
  if (rendererModels.empty() == false) {
    if (PixelBufferWrapper::getIsPBOEnable() == true) {
      Pixmap2D *pixmapScreenShot = BaseColorPickEntity::pbo->getPixelBufferFor(
          x, y, w, h, COLOR_COMPONENTS);
    ...
    map<unsigned char, map<unsigned char, map<unsigned char, bool> > >
    ...
    // to speedup we only check every "skipSteps" line and pixel in a row if we
    // find such a color. this is exact enough for MG purpose
    for (int hh = 0; hh < h && pickedModels.size() < rendererModels.size();
         hh = hh + skipSteps) {
      for (int ww = 0; ww < w && pickedModels.size() < rendererModels.size();
           ww = ww + skipSteps) {
        int index = (hh * w + ww) * COLOR_COMPONENTS;
        unsigned char *pixel = &pixelBuffer[index];
        // printf("pixel[0]=%d pixel[1]=%d
        ...
        //				{
        //					oldpixel =
        //&pixelBuffer[index-1*COLOR_COMPONENTS];
        // if(memcmp(pixel,oldpixel,3)) continue;
        //				}

        // Skip duplicate scanned colors
        map<unsigned char,
            map<unsigned char, map<unsigned char, bool> > >::const_iterator
            iterFind1 = colorAlreadyPickedList.find(pixel[0]);
        if (iterFind1 != colorAlreadyPickedList.end()) {
          map<unsigned char, map<unsigned char, bool> >::const_iterator
              iterFind2 = iterFind1->second.find(pixel[1]);
          if (iterFind2 != iterFind1->second.end()) {
            map<unsigned char, bool>::const_iterator iterFind3 =
                iterFind2->second.find(pixel[2]);
        ...
        for (unsigned int i = 0; i < rendererModels.size(); ++i) {
          ...
          if (model != NULL && model->isUniquePickingColor(pixel) == true) {
            // printf("Found match pixel [%d.%d.%d] for model [%s] ptr
            // [%p][%s]\n",pixel[0],pixel[1],pixel[2],model->getColorDescription().c_str(),
            // model,model->getUniquePickName().c_str());
...
bool BaseColorPickEntity::isUniquePickingColor(unsigned char *pixel) const {
  bool result = false;
  if (uniqueColorID[0] == pixel[0] && uniqueColorID[1] == pixel[1] &&
...
void BaseColorPickEntity::setUniquePickingColor() const {
  glColor3ub(uniqueColorID[0], uniqueColorID[1], uniqueColorID[2]);
