...
void PlatformContextGl::init(int colorBits, int depthBits, int stencilBits, bool hardware_acceleration, bool fullscreen_anti_aliasing, float gammaValue) {
    ...
    if (GlobalStaticFlags::getIsNonGraphicalModeEnabled() == false) {
        ...
        if (Window::getIsFullScreen() && (flags & SDL_WINDOW_FULLSCREEN_DESKTOP) == SDL_WINDOW_FULLSCREEN_DESKTOP) {
            ...
            if (PlatformCommon::Private::ScreenWidth != display_rect.w || PlatformCommon::Private::ScreenHeight != display_rect.h) {
        ...
        if (window == 0) {
            ...
            msg << "Couldn't set video mode " << resW << "x" << resH << " (" << colorBits << "bpp " << stencilBits << " stencil " << depthBits
