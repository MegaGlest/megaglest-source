...
/* import.pl: Skipped the macro definitions, keep only the declarations,
 * converted to use streflop types (aliases or wrappers) */
...
extern int __kernel_rem_pio2f(Simple *, Simple *, int, int, int,
                              const int32_t *);
#endif
...
extern int __kernel_rem_pio2l(Extended *, Extended *, int, int, int,
                              const int *);
#endif
