...
enum SizeState { ssMaximized, ssMinimized, ssRestored };
...
enum WindowStyle { wsFullscreen, wsWindowedFixed, wsWindowedResizable };
...
class Window {
 private:
  ...
  static bool mouseLockedForCameraMovement;
 ...
 public:
  ...
  static void setMouseLockedForCameraMovement(bool isLocked);
  static bool getMouseLockedForCameraMovement() {
    return mouseLockedForCameraMovement;
  }
  ...
  static void setupGraphicsScreen(int depthBits = -1, int stencilBits = -1,
                                  ...
                                  bool fullscreen_anti_aliasing = false);
  ...
  virtual bool ChangeVideoMode(bool preserveContext, int resWidth,
                               int resHeight, bool fullscreenWindow,
                               int colorBits, int depthBits, int stencilBits,
                               bool hardware_acceleration,
                               bool fullscreen_anti_aliasing,
                               float gammaValue) = 0;
  // static void setMasterserverMode(bool value) { Window::masterserverMode =
  // value;} static bool getMasterserverMode() { return
  // Window::masterserverMode;}
