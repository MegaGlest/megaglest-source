...
class Window {
  ...
  public:
    ...
    static bool getMouseLockedForCameraMovement() { return mouseLockedForCameraMovement; }
    ...
    virtual bool ChangeVideoMode(bool preserveContext, int resWidth, int resHeight, bool fullscreenWindow, int colorBits, int depthBits, int stencilBits,
                                 bool hardware_acceleration, bool fullscreen_anti_aliasing, float gammaValue) = 0;
