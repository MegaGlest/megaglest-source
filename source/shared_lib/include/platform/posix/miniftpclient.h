...
enum FTP_Client_ResultType { ftp_crt_SUCCESS = 0, ftp_crt_PARTIALFAIL = 1, ftp_crt_FAIL = 2, ftp_crt_ABORTED = 3, ftp_crt_HOST_NOT_ACCEPTING = 4 };
...
class FTPClientCallbackInterface {
  public:
    ...
    virtual void FTPClient_CallbackEvent(string itemName, FTP_Client_CallbackType type, pair<FTP_Client_ResultType, string> result, void *userdata) = 0;
};
...
class FTPClientThread : public BaseThread, public ShellCommandOutputCallbackInterface {
  protected:
    ...
    pair<FTP_Client_ResultType, string> getTilesetFromServer(pair<string, string> tileSetName, string tileSetNameSubfolder, string ftpUser,
    ...
    pair<FTP_Client_ResultType, string> getFileFromServer(FTP_Client_CallbackType downloadType, pair<string, string> fileNameTitle, string remotePath,
                                                          string destFileSaveAs, string ftpUser, string ftpUserPassword,
                                                          vector<string> *wantDirListOnly = NULL);
  ...
  public:
    FTPClientThread(int portNumber, string serverUrl, std::pair<string, string> mapsPath, std::pair<string, string> tilesetsPath,
