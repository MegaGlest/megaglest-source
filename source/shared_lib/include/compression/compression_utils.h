...
std::pair<unsigned char *, unsigned long> compressMemoryToMemory(
    unsigned char *input, unsigned long input_len, int compressionLevel = 5);
std::pair<unsigned char *, unsigned long> extractMemoryToMemory(
