...
class VideoPlayer {
  ...
  public:
    VideoPlayer(VideoLoadingCallbackInterface *loadingCB, string filename, string filenameFallback, SDL_Window *window, int x, int y, int width, int height,
                int colorBits, bool loop, bool verboseEnabled = false);
    virtual ~VideoPlayer();
