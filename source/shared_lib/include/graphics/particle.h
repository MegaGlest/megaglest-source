...
class AttackParticleSystem : public GameParticleSystem {
 ...
 public:
  ...
  }  // opportunity to do any initialization when the system has been created
...
class ParticleManager {
 ...
 public:
  ...
  void cleanupUnitParticleSystems(
      vector<UnitParticleSystem *> &particleSystems);
  int findParticleSystems(
