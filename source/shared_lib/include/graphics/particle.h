...
class ParticleSystem {
  public:
    ...
    enum BlendMode { bmOne, bmOneMinusAlpha };
...
class GameParticleSystem : public ParticleSystem {
  public:
    enum Primitive { pQuad, pLine, pLineAlpha };
...
class UnitParticleSystem : public GameParticleSystem {
  ...
  public:
    ...
    ParticleSystemTypeInterface *getParticleType() const { return particleSystemType; }
    void setParticleType(ParticleSystemTypeInterface *type) { particleSystemType = type; }
...
class AttackParticleSystem : public GameParticleSystem {
  ...
  public:
    ...
    virtual void initParticleSystem() {} // opportunity to do any initialization when the system has been created
    // and all settings set
...
class ProjectileParticleSystem : public AttackParticleSystem {
  public:
    ...
    enum Trajectory { tLinear, tParabolic, tSpiral };
