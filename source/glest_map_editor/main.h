...
enum BrushType { btHeight, btGradient, btSurface, btObject, btResource, btStartLocation };
...
const char *object_descs[] = {"None (Erase)",   "Tree",    "Dead tree", "Stone (non harvest)", "Bush", "Water object", "Big tree",
                              "Hanged/Impaled", "Statues", "Mountain",  "Invisible blocking"};

const char *resource_descs[] = {"None (Erase)", "Gold", "Stone", "Custom 4", "Custom 5", "Custom 6"};

const char *surface_descs[] = {"Grass", "Sec. grass", "Road", "Stone", "Ground"};
...
class MsgDialog : public wxDialog {
  ...
  public:
    MsgDialog(wxWindow *parent, const wxString &message, const wxString &caption, long style = wxDEFAULT_DIALOG_STYLE | wxRESIZE_BORDER | wxOK | wxCENTRE,
