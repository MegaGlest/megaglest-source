...
public:
  ...
  void randomizeMapHeights(bool withReset, int minimumHeight, int maximumHeight,
                           int chanceDivider, int smoothRecursions);
  ...
  // misc
  void renderMap(int w, int h, pair<int, int> *mouse_pos = NULL,
                 int *radius = NULL);
