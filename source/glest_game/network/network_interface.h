...
class ChatMsgInfo {
  ...
  public:
    ...
    ChatMsgInfo(string chatText, int chatTeamIndex, int chatPlayerIndex, string targetLanguage) {
...
class GameNetworkInterface : public NetworkInterface {
  ...
  public:
    ...
    // message sending
    virtual void sendTextMessage(const string &text, int teamIndex, bool echoLocal, string targetLanguage) = 0;
