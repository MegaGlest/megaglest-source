...
class NetworkMessageIntro : public NetworkMessage {
  ...
  public:
    ...
    NetworkMessageIntro(int32 sessionId, const string &versionString, const string &name, int playerIndex, NetworkGameStateType gameState, uint32 externalIp,
                        uint32 ftpPort, const string &playerLanguage, int gameInProgress, const string &playerUUID, const string &platform);
    ...
    virtual NetworkMessageType getNetworkMessageType() const { return nmtIntro; }
...
class NetworkMessagePing : public NetworkMessage {
  ...
  public:
    ...
    virtual NetworkMessageType getNetworkMessageType() const { return nmtPing; }
...
class NetworkMessageReady : public NetworkMessage {
  ...
  public:
    ...
    virtual NetworkMessageType getNetworkMessageType() const { return nmtReady; }
...
class NetworkMessageLaunch : public NetworkMessage {
  ...
  public:
    ...
    virtual NetworkMessageType getNetworkMessageType() const { return nmtLaunch; }
...
class NetworkMessageCommandList : public NetworkMessage {
  ...
  public:
    ...
    virtual NetworkMessageType getNetworkMessageType() const { return nmtCommandList; }
...
class NetworkMessageText : public NetworkMessage {
  ...
  public:
    NetworkMessageText();
    NetworkMessageText(const string &text, int teamIndex, int playerIndex, const string targetLanguage);

    virtual size_t getDataSize() const { return sizeof(Data); }

    virtual NetworkMessageType getNetworkMessageType() const { return nmtText; }
...
class NetworkMessageQuit : public NetworkMessage {
  ...
  public:
    ...
    virtual NetworkMessageType getNetworkMessageType() const { return nmtQuit; }
...
class NetworkMessageSynchNetworkGameData : public NetworkMessage {
  ...
  public:
    ...
    virtual NetworkMessageType getNetworkMessageType() const { return nmtSynchNetworkGameData; }
...
class NetworkMessageSynchNetworkGameDataStatus : public NetworkMessage {
  ...
  public:
    ...
    virtual NetworkMessageType getNetworkMessageType() const { return nmtSynchNetworkGameDataStatus; }
...
class NetworkMessageSynchNetworkGameDataFileCRCCheck : public NetworkMessage {
  ...
  public:
    ...
    virtual NetworkMessageType getNetworkMessageType() const { return nmtSynchNetworkGameDataFileCRCCheck; }
...
class NetworkMessageSynchNetworkGameDataFileGet : public NetworkMessage {
  ...
  public:
    ...
    virtual NetworkMessageType getNetworkMessageType() const { return nmtSynchNetworkGameDataFileGet; }
...
class SwitchSetupRequest : public NetworkMessage {
  ...
  public:
    ...
    virtual NetworkMessageType getNetworkMessageType() const { return nmtSwitchSetupRequest; }
...
class PlayerIndexMessage : public NetworkMessage {
  ...
  public:
    ...
    virtual NetworkMessageType getNetworkMessageType() const { return nmtPlayerIndexMessage; }
...
class NetworkMessageLoadingStatus : public NetworkMessage {
  ...
  public:
    ...
    virtual NetworkMessageType getNetworkMessageType() const { return nmtLoadingStatusMessage; }
...
class NetworkMessageMarkCell : public NetworkMessage {
  ...
  public:
    ...
    virtual NetworkMessageType getNetworkMessageType() const { return nmtMarkCell; }
...
class NetworkMessageUnMarkCell : public NetworkMessage {
  ...
  public:
    ...
    virtual NetworkMessageType getNetworkMessageType() const { return nmtUnMarkCell; }
...
class NetworkMessageHighlightCell : public NetworkMessage {
  ...
  public:
    ...
    virtual NetworkMessageType getNetworkMessageType() const { return nmtHighlightCell; }
