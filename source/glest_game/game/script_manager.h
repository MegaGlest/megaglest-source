...
enum UnitTriggerEventType { utet_None = 0, utet_HPChanged = 1, utet_EPChanged, utet_LevelChanged, utet_FieldChanged, utet_SkillChanged };

enum CellTriggerEventType { ctet_Unit, ctet_UnitPos, ctet_Faction, ctet_FactionPos, ctet_UnitAreaPos, ctet_FactionAreaPos, ctet_AreaPos };
