...
std::pair<CommandResult, string> AiInterface::giveCommandSwitchTeamVote(
    const Faction *faction, SwitchTeamVote *vote) {
...
std::pair<CommandResult, string> AiInterface::giveCommand(
    int unitIndex, CommandClass commandClass, const Vec2i &pos) {
  assert(this->gameSettings != NULL);
...
std::pair<CommandResult, string> AiInterface::giveCommand(
    int unitIndex, const CommandType *commandType, const Vec2i &pos,
    int unitGroupCommandId) {
  assert(this->gameSettings != NULL);
...
std::pair<CommandResult, string> AiInterface::giveCommand(
    int unitIndex, const CommandType *commandType, Unit *u) {
  assert(this->gameSettings != NULL);
