...
public:
  ...
  giveCommand(int unitIndex, const CommandType *commandType, Unit *u = NULL);
  ...
  std::pair<CommandResult, string>
  giveCommandSwitchTeamVote(const Faction *faction, SwitchTeamVote *vote);
  ...
  bool getNearestSightedResource(const ResourceType *rt, const Vec2i &pos,
