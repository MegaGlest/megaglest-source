...
MenuStateOptionsNetwork::MenuStateOptionsNetwork(Program *program, MainMenu *mainMenu, ProgramState **parentUI)
    : MenuState(program, mainMenu, "config"), buttonOk("Options_Network", "buttonOk"), buttonReturn("Options_Network", "buttonReturn"),

      buttonKeyboardSetup("Options_Network", "buttonKeyboardSetup"), buttonVideoSection("Options_Network", "buttonVideoSection"),
      buttonAudioSection("Options_Network", "buttonAudioSection"), buttonMiscSection("Options_Network", "buttonMiscSection"),
      buttonNetworkSettings("Options_Network", "buttonNetworkSettings"),

      mainMessageBox("Options_Network", "mainMessageBox"),

      labelExternalPort("Options_Network", "labelExternalPort"), labelServerPortLabel("Options_Network", "labelServerPortLabel"),

      labelPublishServerExternalPort("Options_Network", "labelPublishServerExternalPort"), listBoxServerPort("Options_Network", "listBoxServerPort"),

      labelEnableFTP("Options_Network", "labelEnableFTP"), checkBoxEnableFTP("Options_Network", "checkBoxEnableFTP"),

      labelEnableFTPServer("Options_Network", "labelEnableFTPServer"), checkBoxEnableFTPServer("Options_Network", "checkBoxEnableFTPServer"),

      labelFTPServerPortLabel("Options_Network", "labelFTPServerPortLabel"), labelFTPServerPort("Options_Network", "labelFTPServerPort"),

      labelFTPServerDataPortsLabel("Options_Network", "labelFTPServerDataPortsLabel"), labelFTPServerDataPorts("Options_Network", "labelFTPServerDataPorts"),
