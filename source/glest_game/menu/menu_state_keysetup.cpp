...
MenuStateKeysetup::MenuStateKeysetup(Program *program, MainMenu *mainMenu, ProgramState **parentUI)
    : MenuState(program, mainMenu, "config"), buttonOk("KeySetup", "buttonOk"), buttonDefaults("KeySetup", "buttonDefaults"),
      buttonReturn("KeySetup", "buttonReturn"),

      buttonKeyboardSetup("KeySetup", "buttonKeyboardSetup"), buttonVideoSection("KeySetup", "buttonVideoSection"),
      buttonAudioSection("KeySetup", "buttonAudioSection"), buttonMiscSection("KeySetup", "buttonMiscSection"),
      ...
      labelTestTitle("KeySetup", "labelTestTitle"), labelTestValue("KeySetup", "labelTestValue")
...
void MenuStateKeysetup::update() {
    ...
    if (keyScrollBar.getElementCount() != 0) {
        for (int i = keyScrollBar.getVisibleStart(); i <= keyScrollBar.getVisibleEnd(); ++i) {
            keyButtons[i]->setY(keyButtonsYBase - keyButtonsLineHeight * (i - keyScrollBar.getVisibleStart()));
            labels[i]->setY(keyButtonsYBase - keyButtonsLineHeight * (i - keyScrollBar.getVisibleStart()));
        }
    }
