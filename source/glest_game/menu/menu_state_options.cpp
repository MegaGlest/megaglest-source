...
MenuStateOptions::MenuStateOptions(Program *program, MainMenu *mainMenu, ProgramState **parentUI)
    : MenuState(program, mainMenu, "config"), buttonOk("Options", "buttonOk"), buttonReturn("Options", "buttonReturn"),

      labelLang("Options", "labelLang"), listBoxLang("Options", "listBoxLang"), labelPlayerName("Options", "labelPlayerName"),
      labelPlayerNameLabel("Options", "labelPlayerNameLabel"),

      buttonKeyboardSetup("Options", "buttonKeyboardSetup"), buttonVideoSection("Options", "buttonVideoSection"),
      buttonAudioSection("Options", "buttonAudioSection"), buttonMiscSection("Options", "buttonMiscSection"),
      buttonNetworkSettings("Options", "buttonNetworkSettings"),

      labelFontSizeAdjustment("Options", "labelFontSizeAdjustment"), listFontSizeAdjustment("Options", "listFontSizeAdjustment"),

      mainMessageBox("Options", "mainMessageBox"),

      labelScreenShotType("Options", "labelScreenShotType"), listBoxScreenShotType("Options", "listBoxScreenShotType"),
      ...
      labelMouseMoveScrollsWorld("Options", "labelMouseMoveScrollsWorld"), checkBoxMouseMoveScrollsWorld("Options", "checkBoxMouseMoveScrollsWorld"),

      labelCameraMoveSpeed("Options", "labelCameraMoveSpeed"), listCameraMoveSpeed("Options", "listCameraMoveSpeed"),

      labelVisibleHud("Options", "labelVisibleHud"), checkBoxVisibleHud("Options", "checkBoxVisibleHud"), labelHealthBars("Options", "labelHealthBars"),
      listBoxHealthBars("Options", "listBoxHealthBars"),

      labelTimeDisplay("Options", "labelTimeDisplay"), checkBoxTimeDisplay("Options", "checkBoxTimeDisplay"),
      labelChatStaysActive("Options", "labelChatStaysActive"), checkBoxChatStaysActive("Options", "checkBoxChatStaysActive"),
      ...
      labelCustomTranslation("Options", "labelCustomTranslation"), checkBoxCustomTranslation("Options", "checkBoxCustomTranslation"),

      buttonGetNewLanguageFiles("Options", "buttonGetNewLanguageFiles"), buttonDeleteNewLanguageFiles("Options", "buttonDeleteNewLanguageFiles"),
      labelTransifexUserLabel("Options", "labelTransifexUserLabel"), labelTransifexUser("Options", "labelTransifexUser"),
      labelTransifexPwdLabel("Options", "labelTransifexPwdLabel"), labelTransifexPwd("Options", "labelTransifexPwd"),
      labelTransifexI18NLabel("Options", "labelTransifexI18NLabel"), labelTransifexI18N("Options", "labelTransifexI18N")
...
void MenuStateOptions::mouseClick(int x, int y, MouseButton mouseButton) {
    ...
    if (mainMessageBox.getEnabled()) {
        ...
        bool saveChanges = (orig_txnURLUser != labelTransifexUser.getText() || orig_txnURLLang != labelTransifexI18N.getText());
...
bool MenuStateOptions::textInput(std::string text) {
    if (activeInputLabel != NULL) {
        // printf("[%d]\n",c); fflush(stdout);
        if (&labelPlayerName == activeInputLabel || &labelTransifexUser == activeInputLabel || &labelTransifexPwd == activeInputLabel ||
