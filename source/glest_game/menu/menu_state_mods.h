...
// 	class MenuStateMods
// ===============================
class MenuStateMods : public MenuState,
...
private:
  bool eventMouseWheel(GraphicScrollBar *scrollBar, UserButtons *buttons, int x,
                       int y, int zDelta);
  void layoutButtons(GraphicScrollBar *scrollBar, UserButtons *buttons,
