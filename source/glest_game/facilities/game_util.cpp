...
string getAboutString1(int i) {
    ...
    switch (i) {
    case 0:
        return "MegaGlest " + glestVersionString + " (" + "Shared Library " + sharedLibVersionString + ")";
    case 1:
        return GIT_Rev;
    case 2:
...
string getGameCustomCoreDataPath(string originalBasePath, string uniqueFilePath) {
    ...
    if (custom_mod_path != "" && (uniqueFilePath == "" || fileExists(custom_mod_path + uniqueFilePath) == true)) {
        result = custom_mod_path + uniqueFilePath;
    } else if (data_path != "" && (uniqueFilePath == "" || fileExists(data_path + uniqueFilePath) == true)) {
