...
class VisibleQuadContainerCache {
  ...
  public:
    ...
    inline VisibleQuadContainerCache(const VisibleQuadContainerCache &obj) { CopyAll(obj); }
...
class Renderer : public RendererInterface,
      ...
      private:
        ...
        struct Layer {
            inline explicit Layer(int th)
                : vbo_vertices(0), vbo_normals(0), vbo_fowTexCoords(0), vbo_surfTexCoords(0), vbo_indices(0), indexCount(0), textureHandle(th), textureCRC(0) {}
            ...
            GLuint vbo_vertices, vbo_normals, vbo_fowTexCoords, vbo_surfTexCoords, vbo_indices;
            int indexCount;
            int textureHandle;
            string texturePath;
            uint32 textureCRC;
  ...
  public:
    ...
    Model *newModel(ResourceScope rs, const string &path, bool deletePixMapAfterLoad = false,
                    std::map<string, vector<pair<string, string>>> *loadedFileList = NULL, string *sourceLoader = NULL);
    ...
    void renderConsoleLine3D(int lineIndex, int xPosition, int yPosition, int lineHeight, Font3D *font, string stringToHightlight,
                             const ConsoleLineInfo *lineInfo);
    void renderConsoleLine(int lineIndex, int xPosition, int yPosition, int lineHeight, Font2D *font, string stringToHightlight,
                           const ConsoleLineInfo *lineInfo);
    ...
    void selectUsingSelectionBuffer(Selection::UnitContainer &units, const Object *&obj, const bool withObjectSelection, const Vec2i &posDown,
                                    const Vec2i &posUp);
    void selectUsingFrustumSelection(Selection::UnitContainer &units, const Object *&obj, const bool withObjectSelection, const Vec2i &posDown,
                                     const Vec2i &posUp);
  ...
  private:
    ...
    int renderResource(const Faction *factionForResourceView, bool localFactionResourcesOnly, bool twoResourceLines, const ResourceType *rt, int startRow,
