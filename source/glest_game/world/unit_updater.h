...
class UnitUpdater {
  ...
  private:
    ...
    bool findCachedCellsEnemies(Vec2i center, int range, int size, vector<Unit *> &enemies, const AttackSkillType *ast, const Unit *unit,
                                const Unit *commandTarget);
    void findEnemiesForCell(const AttackSkillType *ast, Cell *cell, const Unit *unit, const Unit *commandTarget, vector<Unit *> &enemies);
  ...
  private:
    ...
    void spawnAttack(Unit *unit, string spawnUnit, int spawnUnitcount, int healthMin, int healthMax, int probability, bool spawnUnitAtTarget,
    ...
    void SwapActiveCommandState(Unit *unit, CommandStateType commandStateType, const CommandType *commandType, int originalValue, int newValue);
