...
//
//		XmlNode *unitReqsNode =
// requirableTypeNode->addChild("unitReqs");
//		unitReqsNode->addAttribute("name",ut->getName(),
// mapTagReplacements);
//	}
...
////	int productionTime;
//	producibleTypeNode->addAttribute("productionTime",intToStr(productionTime),
// mapTagReplacements);
//}

// void ProducibleType::loadGame(const XmlNode *rootNode) {
//	const XmlNode *producibleTypeNode =
// rootNode->getChild("ProducibleType");
//
