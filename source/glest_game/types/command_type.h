...
enum Clicks { cOne, cTwo };

enum Queueability { qNever, qOnRequest, qOnlyLast, qAlways };
...
class CommandHelper {  // TODO put magic numbers to settings
 public:
  ...
  inline static vector<CommandClass> getBasicsCC() {
    return {ccAttack, ccStop, ccMove, ccAttackStopped};
  }
  inline static vector<CommandClass> getCoresCC() {
    return {ccAttack, ccProduce, ccUpgrade,       ccSwitchTeam, ccHarvest,
            ccRepair, ccBuild,   ccAttackStopped, ccMove,       ccStop};
  }
