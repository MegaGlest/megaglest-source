...
void ProjectileType::load(const XmlNode *projectileNode, const string &dir, const string &techtreepath,
    ...
    projectileParticleSystemType->load(particleNode, dir, currentPath + path, &Renderer::getInstance(), loadedFileList, parentLoader, techtreepath);
