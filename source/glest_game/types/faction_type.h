...
enum AIBehaviorUnitCategory { aibcWorkerUnits, aibcWarriorUnits, aibcResourceProducerUnits, aibcBuildingUnits };
...
template <> inline EnumParser<AIBehaviorStaticValueCategory>::EnumParser() {
...
class FactionType {
  ...
  public:
    // init
    FactionType();
    void load(const string &factionName, const TechTree *techTree, Checksum *checksum, Checksum *techtreeChecksum,
