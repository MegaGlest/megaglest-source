...
enum DisplayState { dsEmpty, dsUnitSkills, dsUnitBuild, dsEnemy };
...
private:
  ...
  void addOrdersResultToConsole(CommandClass cc,
  ...
  bool computeTarget(const Vec2i &screenPos, Vec2i &targetPos,
